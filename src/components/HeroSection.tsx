  ...
  return <section ref={parallaxRef} className="relative min-h-[85vh] sm:min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 text-center pt-20 sm:pt-24">
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        transform: `translateY(${-offset}px)`
          ...
          <h1 className="font-serif text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-normal leading-tight text-foreground mb-4 sm:mb-6 text-center px-2">
        ...
        transform: `translateY(${-offset * 0.5}px)`
          ...
          <p className="text-muted-foreground text-sm sm:text-base md:text-lg max-w-2xl mx-auto mb-8 sm:mb-10 leading-relaxed text-center px-2">
        ...
        <div ref={btnRef} className={cn("flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 transition-all duration-1000 delay-400 ease-out", btnVisible ? "opacity-100 translate-y-0 scale-100" : "opacity-0 translate-y-6 scale-95")}>
